export const THEME_TOKEN_MAP = {
    ...
    "background.app": "--color-bg-app",
    "background.elevated": "--color-bg-elevated",
    "background.hover": "--color-bg-hover",
    "background.active": "--color-bg-active",
    ...
    "semantic.ring": "--ring",
    "semantic.amber": "--color-amber",
    "semantic.amberSoft": "--color-amber-soft",
    "semantic.green": "--color-green",
    "semantic.pink": "--color-pink",
    "semantic.pinkSoft": "--color-pink-soft",
